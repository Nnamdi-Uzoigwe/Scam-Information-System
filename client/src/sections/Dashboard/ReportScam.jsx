  ...
  const [formData, setFormData] = useState({
    ...
    //       ...(formData.wasThroughAd && formData.wasThroughAd !== "" && {
    //         wasThroughAd: formData.wasThroughAd
    //       }),
  ...
  const requiredFields = {
    'scammerName.firstName': formData.scammerName.firstName,
    'scammerName.surname': formData.scammerName.surname,
    gender: formData.gender,
    scamType: formData.scamType,
  ...
  try {
    ...
    ].filter(num => num && num.trim()).map(num => num.trim());
    ...
    if (Object.values(formData.physicalAddress).some(val => val && val.trim())) {
      ...
      physicalAddress.country = formData.physicalAddress.country?.trim() || '';
    }
    ...
    // Upload scammer photos if exist
    ...
    const payload = {
      scammerName: {
        firstName: formData.scammerName.firstName.trim(),
        surname: formData.scammerName.surname.trim(),
        ...(formData.scammerName.otherNames && {
          otherNames: formData.scammerName.otherNames.trim()
        })
      },
      gender: formData.gender,
    ...
    setFormData({
      scammerName: { firstName: "", surname: "", otherNames: "" },
      gender: "",
      telephoneNumber1: "",
      telephoneNumber2: "",
      emailAddresses: [""],
      physicalAddress: { line1: "", line2: "", city: "", state: "", country: "" },
      scamType: "",
      scamLocationType: "",
