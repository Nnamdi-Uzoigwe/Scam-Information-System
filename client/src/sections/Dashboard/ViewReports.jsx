...
//           "https://scam-information-system.onrender.com/api/scam-reports/my-reports",
//           {
//             headers: {
...
//     try {
//       const token = localStorage.getItem('token');
//       const response = await fetch(`https://scam-information-system.onrender.com/api/scam-reports/${caseId}`, {
//         method: 'DELETE',
//         headers: { 
//           'Authorization': `Bearer ${token}`,
//           'Content-Type': 'application/json'
...
//       setReports(prevReports => prevReports.filter(report => report.caseId !== caseId));
//     } catch (err) {
...
//             <Link
//               to="/report-scam"
//               className="mt-4 inline-block px-6 py-2 bg-[#0F766E] text-white rounded-lg hover:bg-[#0d625b]"
//             >
//               Report a New Scam
//             </Link>
//           </div>
...
//                           Alleged Scammer: {scam.scammerName}
//                         </h3>
...
//                         <span className="">
//                           Reported on{" "}
//                           {new Date(scam.dateReported).toLocaleDateString()}
//                         </span>
//                       </div>
//                       <div className="mt-1">
//                         <span
...
//                           )}
//                           {scam.status.charAt(0).toUpperCase() +
//                             scam.status.slice(1)}
//                         </span>
//                       </div>
//                     </div>
